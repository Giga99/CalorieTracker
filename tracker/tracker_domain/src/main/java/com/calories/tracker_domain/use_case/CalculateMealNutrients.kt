...
import com.calories.tracker_domain.model.MealType
...
class CalculateMealNutrients(
    ...
    operator fun invoke(trackedFoods: List<TrackedFood>): Result {
        ...
        val carbsGoal = (caloryGoal * userInfo.carbRatio / CARB_NUM_OF_CALORIES).roundToInt()
        val proteinGoal = (caloryGoal * userInfo.proteinRatio / PROTEIN_NUM_OF_CALORIES).roundToInt()
        val fatGoal = (caloryGoal * userInfo.fatRatio / FAT_NUM_OF_CALORIES).roundToInt()
...
private const val CARB_NUM_OF_CALORIES = 4f
private const val PROTEIN_NUM_OF_CALORIES = 4f
private const val FAT_NUM_OF_CALORIES = 9f
